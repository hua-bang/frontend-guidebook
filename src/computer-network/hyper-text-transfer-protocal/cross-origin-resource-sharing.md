...
2. 自定义设置集合外的头部字段
   ...
   - Content-Type
     ...
     （例如application/json为非简单请求）指示资源的 MIME 类型
...
注意：HTML 中 `<link>`、`<script>`、`<img>` 等标签自带连接属性进行 HTTP 请求是能够无视同源策略的.

---

**参考资料**：

- [CORS](https://tsejx.github.io/javascript-guidebook/computer-networks/http/cross-origin-resource-sharing)
